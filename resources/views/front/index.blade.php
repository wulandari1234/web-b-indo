                ...
                <div class="featured-news-card relative w-full h-[550px] flex shrink-0 overflow-hidden">
                    ...
                    <div
                        ...
                        <div class="flex flex-col gap-[10px]">
                            ...
                            <a href="{{ route('front.details', $post->slug) }}"
                                class="font-bold text-4xl leading-[45px] text-white two-lines hover:underline transition-all duration-300">{{ $post->judul }}</a>
                            <p class="text-white">{{ $post->created_at->format('M d,Y') }}• {{ $post->category->judul }}
                            </p>
                        </div>
